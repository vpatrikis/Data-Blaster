...
- Track common data quality signals such as blank values, missing values, repeated values, and explicit validation issues.
...
- `validation_issues` lists actionable findings for missing values, duplicate rows, and type changes.
...
- Expand validation with configurable rules and threshold-based checks.
